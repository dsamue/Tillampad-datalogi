...
class Atom:                         #Atomklass, inget konstigt
...
def skapaAtomlista():         #Returnerar lista med alla atomnamn + vikt
...
def allaAtomerFinns(hashtabell, atomlista):   #Testar bara att tabellen funkar
    ...
    for kontrollAtom in atomlista:
        ...
        try:
            ...
            '''print(hashadAtom)
            print('hej')
            print(type(hashadAtom))
            print(hashadAtom.self.data)
            print(hashadAtom.data.vikt)
            print(hashadAtom.data.namn)
            type(hashadAtom)
            type(hashadAtom.data) '''
            if hashadAtom.vikt != vikt:     #egen mod .data.vikt
...
def knasAtomFinnsInte(hashtabell):    #Kollar att inte konstiga namn hittas

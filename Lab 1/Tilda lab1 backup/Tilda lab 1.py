class Gympapass:                # Klass för varje gympa pass
    ...
    def __str__(self):              #Någon anledning till att inte använda __repr__ ist?
        return'Det här är vad som returneras för ett visst pass' # typ info?
...
def las_in_fil():
    infil=open('egenlista.txt', 'r')      #får inte andra textfiler att funka?
    passinfo=[]
    passen=[]
...
##kolla formella grejerna labben + hederskod
...
##kör på egen textfil sålänge. utf8 och inga åäö. i skolans fil blir bl.a é knasigt. 

...
def görabarn(nod, slutord, ordlistan, dumbarnen, stack):          #Skapar nya ord genom att byta ut en bokstav i nodens ord
   ...
   for i in range(len(alfabetet)):                           #Tre fall för 1a, 2a, 3e bokstaven i ordet. Hade kunnat göra två loopar                      
      ...
      kontrollerabarn(ordförsök, nod, slutord, ordlistan, dumbarnen, stack)
...
def kontrollerabarn(ordförsök,nod,slutord,ordlistan, dumbarnen, stack):         #Kontrollerar om ordförsök är ett riktigt ord och om vi nått slutordet
...
def huvudprogram():                    #Letar en ordkedja mellan två trestaviga ord (djupet först)
   ...
   try:                                         #Try/except fångar upp sys.exit och dess traceback vid funnet slutord
      while not stack.isEmpty():
         nod=stack.pop()
         görabarn(nod, slutord, ordlistan, dumbarnen, stack)
   except SystemExit:
      print('\nProgrammet avslutat')
